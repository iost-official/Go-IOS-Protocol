...
var callCmd = &cobra.Command{
	...
	Example: `  iwallet call "token.iost" "transfer" '[global.Token,"user0001","user0002","123.45",""]' --account test0
  iwallet call "token.iost" "transfer" '[global.Token,"user0001","user0002","123.45",""]' --output tx.json`,
